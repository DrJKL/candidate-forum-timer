...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/candidates.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.allCandidates = void 0;
...
var Candidate = /*#__PURE__*/function () {
  ...
  _createClass(Candidate, [{
    ...
    value: function getTimeLeft() {
      var timeToUse = this.isTimeUp() ? moment.duration().subtract(this.timeLeft) : this.timeLeft;
      return "".concat(timeToUse.minutes().toString().padStart(2, 0), ":") + "".concat(timeToUse.seconds().toString().padStart(2, 0), ":") + "".concat(timeToUse.milliseconds().toString().padStart(3, 0));
    }
  }, {
    key: "getProgressPercent",
    value: function getProgressPercent() {
      return "".concat(100 * (this.timeLeft.asMilliseconds() / Candidate.timeLimitTotal.asMilliseconds()), "%");
    }
  }, {
    key: "isTimeUp",
    value: function isTimeUp() {
...
_defineProperty(Candidate, "timeLimitTotal", moment.duration(10, 's'));

_defineProperty(Candidate, "timeGranularity", 50);

_defineProperty(Candidate, "timeDelta", moment.duration(1, 's'));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3462" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/candidates.js"], null)
//# sourceMappingURL=/candidates.744472b0.js.map