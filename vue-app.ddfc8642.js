...
var Config = /*#__PURE__*/function () {
  function Config() {
    ...
    this.eventInfo = {
      //
      logoUrl: _.default['just_homes_logo'],
      // images['lwv-logo'],
      //
  ...
  _createClass(Config, [{
    ...
    key: "updateOrg",
    value: function updateOrg(orgTitle) {
      this.updateInfo({
        orgTitle: orgTitle
      });
    }
    ...
    key: "updateEvent",
    value: function updateEvent(eventTitle) {
      this.updateInfo({
    ...
    key: "updateLogo",
    value: function updateLogo(logoUrl) {
      this.updateInfo({
        logoUrl: logoUrl
      });
    }
    ...
    key: "updateInfo",
    value: function updateInfo(newInfo) {
      this.eventInfo = Object.assign(Object.assign({}, this.eventInfo), newInfo);
      saveConfig();
    }
  }]);
...
var Timer = /*#__PURE__*/function () {
  ...
  _createClass(Timer, [{
    ...
    value: function toggleTimer() {
      ...
      if (force === true) {
        this.countingDown = window.setInterval(function () {
    ...
    key: "setTime",
    value: function setTime(num, unit) {
    ...
    value: function getTimeLeft() {
      ...
      return "".concat(timeToUse.minutes().toString().padStart(2, '0'), ":") + "".concat(timeToUse.seconds().toString().padStart(2, '0'), ".") + "".concat(timeToUse.milliseconds().toString().substr(0, 1));
    }
  }, {
    key: "millisLeft",
    get: function get() {
...
},{"./timer":"src/js/timer.ts"}],"src/js/common/shuffle.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/js/common/blur.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/js/common/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./shuffle":"src/js/common/shuffle.ts","./blur":"src/js/common/blur.ts"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _vueCollapseTransition = require("@ivanv/vue-collapse-transition");
...
var CandidateCard = /*#__PURE__*/function (_Vue) {
  _inherits(CandidateCard, _Vue);

  var _super = _createSuper(CandidateCard);

  function CandidateCard() {
    _classCallCheck(this, CandidateCard);

    return _super.apply(this, arguments);
  }

  _createClass(CandidateCard, [{
            ...
            _c("div", { staticClass: "time-section" }, [
              _c("div", { staticClass: "time-left" }, [
                _vm._v(
                  "\n          " +
                    ...
                    "\n          " +
                    _vm._s(
                      _vm.candidate.timer.isTimeUp ? "over" : "remaining"
                    ) +
                    "\n        "
                ),
              ]),
              ...
              _c(
                ...
                [
                  _c("div", {
                    class: {
                      determinate: !_vm.candidate.timer.isTimeUp,
                      indeterminate: _vm.candidate.timer.isTimeUp,
                    },
...
},{"vue-property-decorator":"node_modules/vue-property-decorator/lib/index.js","./candidates":"src/js/candidates.ts","@ivanv/vue-collapse-transition":"node_modules/@ivanv/vue-collapse-transition/dist/collapse-transition.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/js/header.vue":[function(require,module,exports) {
"use strict";
...
var Header = /*#__PURE__*/function (_Vue) {
  ...
  function Header() {
    ...
    _this.blurElement = _common.blurElement;
    return _this;
  }
  ...
  _createClass(Header, [{
    ...
    key: "updateGalleryMode",
    value: function updateGalleryMode() {
...
},{"vue-property-decorator":"node_modules/vue-property-decorator/lib/index.js","./global_config":"src/js/global_config.ts","./common":"src/js/common/index.ts","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/js/focus_manager.ts":[function(require,module,exports) {
"use strict";
...
var FocusManager = /*#__PURE__*/function () {
  ...
  _createClass(FocusManager, [{
    ...
    key: "isNext",
    value: function isNext(index) {
      return this.focusedCandidate === index - 1;
    }
  }, {
    key: "isPrev",
    value: function isPrev(index) {
      return this.focusedCandidate === index + 1;
    }
  }]);
...
var App = /*#__PURE__*/function (_Vue) {
  ...
  _createClass(App, [{
    ...
    key: "getCardClasses",
    value: function getCardClasses(index) {
      return {
    ...
    key: "toCandidates",
    value: function toCandidates(commaSeparated) {
      return commaSeparated.split(',').map(function (s) {
        return s.trim();
      }).filter(Boolean);
    }
  }, {
    ...
    value: function dumpQuestions() {
      ...
      _materializeCss.default.toast({
        html: questionsString
      });
    }
  }, {
    key: "questionEditDone",
    value: function questionEditDone(event) {
      if (!(event.target instanceof HTMLElement)) {
        return;
      }

      var newQuestion = event.target.innerText;

      _global_config.globalConfig.addQuestion(newQuestion);
    }
  }, {
    key: "showCandidateDialog",
    value: function showCandidateDialog() {
      this.tempCandidates = this.allCandidates.map(function (candidate) {
        return candidate.name;
      }).join(', ');
    ...
    value: function setQuestionEditable(event) {
      if (!(event.target instanceof HTMLElement)) {
        return;
      }
    ...
    key: "setTitleEditable",
    value: function setTitleEditable() {
    ...
    key: "setOrgEditable",
    value: function setOrgEditable() {
      var element = document.getElementById('org-title');
    ...
    key: "resetDialogClosed",
    value: function resetDialogClosed(event) {
      var _a;

      if (!((_a = this.resetDialog) === null || _a === void 0 ? void 0 : _a.returnValue)) {
        return;
      }

      if (this.resetDialog.returnValue !== 'reset_please') {
        console.log('Not actually resetting, dialog value:', this.resetDialog.returnValue, '\nProbably need to be more polite about it.');
        return;
      }
    ...
    key: "logoDialogClosed",
    value: function logoDialogClosed(event) {
      var _a;

      if (!((_a = this.logoDialog) === null || _a === void 0 ? void 0 : _a.returnValue) || this.logoDialog.returnValue === 'cancel') {
        return;
      }
    ...
    key: "candidatesDialogClosed",
    value: function candidatesDialogClosed(event) {
      var _a;

      if (!((_a = this.candidatesDialog) === null || _a === void 0 ? void 0 : _a.returnValue) || this.candidatesDialog.returnValue === 'cancel') {
        return;
      }
    ...
    key: "questionsDialogClosed",
    value: function questionsDialogClosed(event) {
      var _a;
    ...
    [
      ...
      _c(
        "dialog",
        {
          ...
          staticClass: "config-dialog",
          on: { close: _vm.logoDialogClosed },
        },
        [
          _c("div", { staticClass: "card content-wrapper" }, [
            _c("h1", { staticClass: "header" }, [_vm._v("Set New Logo")]),
            _vm._v(" "),
            _c("div", { staticClass: "card-content" }, [
              _c("div", { staticClass: "logo-instructions" }, [
                _c("p", [_vm._v("Input url for logo")]),
                _vm._v(" "),
                _vm.tempImg
                  ? _c("img", {
                      attrs: { src: _vm.tempImg, alt: "preview for the logo" },
                    })
                  : _vm._e(),
              ]),
              _vm._v(" "),
              _c("input", {
                ...
                domProps: { value: _vm.tempImg },
                on: {
                  input: function ($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.tempImg = $event.target.value
                  },
                },
              }),
            ]),
            ...
            _c(
              "form",
              {
                ...
                attrs: { id: "logo-form", method: "dialog" },
              },
              [
                _c(
                  "button",
                  {
                    staticClass: "btn blue darken-4 z-depth-2 please-button",
                    attrs: { type: "submit", value: _vm.tempImg },
                  },
                  [_vm._v("\n          Set New Logo\n        ")]
                ),
                _vm._v(" "),
      ...
      _c(
        "dialog",
        {
          ...
          staticClass: "config-dialog",
          on: { close: _vm.candidatesDialogClosed },
        },
        [
          _c("div", { staticClass: "card content-wrapper" }, [
            _c("h1", { staticClass: "header" }, [_vm._v("Set New Candidates")]),
            _vm._v(" "),
            _c("div", { staticClass: "card-content" }, [
              _c("p", [_vm._v("List the candidates, comma separated")]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.tempCandidates,
                    expression: "tempCandidates",
                  },
                ],
                attrs: {
                  type: "text",
                ...
                domProps: { value: _vm.tempCandidates },
                on: {
                  input: function ($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.tempCandidates = $event.target.value
                  },
                },
              }),
              _vm._v(" "),
            ...
            _c(
              ...
              {
                staticClass: "card-action",
                attrs: { id: "candidates-form", method: "dialog" },
              },
              [
                _c(
                  "button",
                  {
                    staticClass: "btn blue darken-4 z-depth-2 please-button",
                    attrs: { type: "submit", value: _vm.tempCandidates },
                  },
                  [_vm._v("\n          Set New Candidates\n        ")]
                ),
                _vm._v(" "),
      ...
      _c(
        "dialog",
        {
          ...
          staticClass: "config-dialog",
          on: { close: _vm.questionsDialogClosed },
        },
        [
          _c("div", { staticClass: "card content-wrapper" }, [
...
var staticRenderFns = [
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "card content-wrapper" }, [
      _c("h1", { staticClass: "header" }, [_vm._v("Resetting Config!")]),
      _vm._v(" "),
      _c("p", { staticClass: "card-content" }, [
        _vm._v("\n        Are you sure you want to "),
        _c("b", [_vm._v("Reset")]),
        _vm._v(" all fields? This action cannot\n        be undone.\n      "),
      ]),
      _vm._v(" "),
      _c("form", { staticClass: "card-action", attrs: { method: "dialog" } }, [
        _c(
          "button",
          {
            staticClass: "btn red darken-4 z-depth-2 please-button",
            attrs: { type: "submit", value: "reset_please" },
          },
          [_vm._v("\n          RESET IT ALL\n        ")]
        ),
        _vm._v(" "),
        _c(
          ...
          {
            staticClass: "btn",
            attrs: { type: "submit", value: "reset_cancel" },
          },
          [_vm._v("Cancel")]
        ),
      ]),
  ...
  function () {
    ...
    return _c(
      ...
      {
        staticClass: "card-action",
        attrs: { id: "questions-form", method: "dialog" },
      },
      [
        _c(
          "button",
          {
            staticClass: "btn blue darken-4 z-depth-2 please-button",
            attrs: { type: "submit", value: "new_questions_please" },
          },
        ...
        _c(
          "button",
          { staticClass: "btn", attrs: { type: "submit", value: "cancel" } },
          [_vm._v("Cancel")]
        ),
      ]
    )
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./app.vue":"src/js/app.vue","@mdi/font/css/materialdesignicons.css":"node_modules/@mdi/font/css/materialdesignicons.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
